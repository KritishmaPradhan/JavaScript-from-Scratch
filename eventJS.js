...
// let headingmain = document.querySelector("h1");
// theme = "light";
// const theme_function = () => {
//     if( theme === "light"){
//         theme = "dark";
//         mainBody.classList.remove("light");
//         headingmain.classList.remove("light");
//         mainBody.classList.add("dark");
//         headingmain.classList.add("dark");
//     }
//     else{
//         theme = "light";
//         mainBody.classList.remove("dark");
//         headingmain.classList.remove("dark");
//         mainBody.classList.add("light");
//         headingmain.classList.add("light");
//     }
// }
